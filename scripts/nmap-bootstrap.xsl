      ...
      <!-- <body>
        ...
        <div class="ui centered ten wide column">
          <div class="ui teal segment">
            ...
            <h2 id="scannedhosts" class="target">Firstly, here's everything we found.<xsl:if test="/nmaprun/runstats/hosts/@down > 1024"><small> (offline hosts are hidden)</small></xsl:if></h2>
            ...
            <h2 id="onlinehosts" class="target">These devices are online right now:
            </h2>
            <xsl:for-each select="/nmaprun/host[status/@state='up']">
          ...
          <footer class="ui footer">
            <div class="ui container">
              <p class="text-muted">
                ...
                Adapted by Nick Kelly for the purposes of a proof of concept university project.
              </p>
            </div>
          </footer>
        <!-- </body>
